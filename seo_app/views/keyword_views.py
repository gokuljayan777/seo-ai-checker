...
from ..services.keyword_research import search_keywords, compare_keywords, get_keyword_recommendations
from ..models import Keyword, KeywordRanking, Domain
...
def keyword_difficulty(request):
    ...
    try:
        ...
        return Response({
            ...
            "search_volume": result.get("search_volume", 0),
            "ranking_difficulty": "This keyword is " + result.get("competition", "Medium").lower() + " competition"
        })
