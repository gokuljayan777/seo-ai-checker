...
class KeywordResearcher:
    ...
    def _serpapi_search_volume(self, keyword: str) -> int:
        ...
        def _serpapi_search_volume(self, keyword: str) -> int:
            ...
            try:
                ...
                logger.info(f"No search_information in SerpAPI response for '{keyword}', using heuristic")
                return self._heuristic_search_volume(keyword)
            except Exception as e:
    ...
    def _heuristic_search_volume(self, keyword: str) -> int:
        ...
        if any(word in keyword_lower for word in ["how to", "what is", "best", "guide"]):
    ...
    def _calculate_keyword_difficulty(self, keyword: str) -> int:
        ...
        if any(word in keyword_lower for word in ["amazon", "ebay", "apple", "google", "facebook"]):
            difficulty += 25
    ...
    def _classify_search_intent(self, keyword: str) -> str:
        ...
        transactional_words = ["buy", "shop", "order", "price", "cost", "cheap", "deal", "discount", "coupon"]
    ...
    def _estimate_cpc(self, keyword: str) -> float:
        ...
        # Base CPC by type
        if any(word in keyword_lower for word in ["insurance", "lawyer", "mortgage", "loan"]):
    ...
    def get_keyword_recommendations(self, domain: str, industry: str = "") -> List[Dict]:
        """
        ...
        industry_keywords = {
            "saas": ["saas for", "best saas", "saas solutions", "saas tools", "saas platform"],
            "ecommerce": ["buy online", "shop", "best price", "online store", "free shipping"],
            "services": ["services near me", "best services", "affordable services", "local services"],
        ...
        keywords_to_check = industry_keywords.get(industry.lower(), [
            "best", "how to", "guide", "tips", "review"
        ])
